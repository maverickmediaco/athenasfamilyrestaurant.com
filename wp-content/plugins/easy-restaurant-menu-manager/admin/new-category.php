    ...
    <table class="form-table">
      <tbody>
        ...
        <tr valign="top">
          ...
          <td>
            <input type="hidden" name="wprmm[show_description]" value="0" />
            <input type="checkbox" name="wprmm[show_description]" value="1" <?php echo ($category->show_description == 1) ? 'checked' : '';?>/>
