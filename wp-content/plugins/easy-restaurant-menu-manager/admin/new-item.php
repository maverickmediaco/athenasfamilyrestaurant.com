    ...
    <table class="form-table">
      <tbody>
        ...
        <tr valign="top">
          ...
          <td>
            <?php $price = empty( $item->price ) ? '' : $item->price; ?>
            <input name="wprmm[price]" type="text" value="<?php echo $price;?>" class="regular-text">
        ...
        <tr valign="top">
          ...
          <td>
            <?php $second_price = empty( $item->second_price ) ? '' : $item->second_price; ?>
            <input name="wprmm[second_price]" type="text" value="<?php echo $second_price;?>" class="regular-text">
        ...
        <tr valign="top">
          ...
          <td>
            <input type="hidden" name="wprmm[active]" value="0" />
        ...
        <tr valign="top">
          ...
          <td>
            <?php $display_order = empty( $item->display_order ) ? '' : $item->display_order; ?>
            <input name="wprmm[display_order]" type="text" value="<?php echo $display_order;?>" class="regular-text">
